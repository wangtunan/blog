import{_ as o,r as e,o as c,c as l,e as s,a as p,b as t,d as a}from"./app-8a044cf5.js";const k={},u=p("h1",{id:"简单",tabindex:"-1"},[p("a",{class:"header-anchor",href:"#简单","aria-hidden":"true"},"#"),t(" 简单")],-1),r=p("h2",{id:"_21-合并两个有序链表",tabindex:"-1"},[p("a",{class:"header-anchor",href:"#_21-合并两个有序链表","aria-hidden":"true"},"#"),t(" 21.合并两个有序链表")],-1),i=a(`<p>方法一：递归</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// m和n分别为两个链表的长度</span>
