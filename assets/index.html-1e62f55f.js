import{_ as n,o as s,c as a,d as t}from"./app-3e6e6a3e.js";const p={},o=t(`<h1 id="go基础" tabindex="-1"><a class="header-anchor" href="#go基础" aria-hidden="true">#</a> Go基础</h1><h2 id="约定规则" tabindex="-1"><a class="header-anchor" href="#约定规则" aria-hidden="true">#</a> 约定规则</h2><p>Go中有一些约定的规则：</p><ul><li>每个<code>.go</code>文件必须有一个包名，例如<code>package main</code>，其中<code>main</code>即为包名。</li><li>严格区分大小写，大写开头的变量、常量或者方法可跨包访问。</li><li>双引号代表字符串，单引号代表字符，例如：<code>&quot;abc&quot;</code>和<code>&#39;a&#39;</code>。</li><li>不需要写分号。</li></ul><h2 id="注释" tabindex="-1"><a class="header-anchor" href="#注释" aria-hidden="true">#</a> 注释</h2><div class="language-go" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> main
...
</code></pre></div><h2 id="for循环" tabindex="-1"><a class="header-anchor" href="#for循环" aria-hidden="true">#</a> for循环</h2><p><code>Golang</code>的<code>for</code>循环中，<code>break</code>和<code>continue</code>依旧分别表示中断循环和继续下一次循环。</p><h3 id="for循环的三种方式" tabindex="-1"><a class="header-anchor" href="#for循环的三种方式" aria-hidden="true">#</a> for循环的三种方式</h3><div class="language-go" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> main
...
</code></pre></div><h2 id="函数" tabindex="-1"><a class="header-anchor" href="#函数" aria-hidden="true">#</a> 函数</h2><h2 id="数组和切片" tabindex="-1"><a class="header-anchor" href="#数组和切片" aria-hidden="true">#</a> 数组和切片</h2><h2 id="map" tabindex="-1"><a class="header-anchor" href="#map" aria-hidden="true">#</a> map</h2><h2 id="结构体和自定义数据类型" tabindex="-1"><a class="header-anchor" href="#结构体和自定义数据类型" aria-hidden="true">#</a> 结构体和自定义数据类型</h2><h2 id="方法和接口" tabindex="-1"><a class="header-anchor" href="#方法和接口" aria-hidden="true">#</a> 方法和接口</h2><h2 id="协程-channel" tabindex="-1"><a class="header-anchor" href="#协程-channel" aria-hidden="true">#</a> 协程/channel</h2>`,83),e=[o];function c(u,l){return s(),a("div",null,e)}const d=n(p,[["render",c],["__file","index.html.vue"]]);export{d as default};
