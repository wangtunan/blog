import{_ as o,r as e,o as c,c as l,a as n,b as s,e as t,d as p}from"./app-ef3230e2.js";const u={},r=n("h1",{id:"简单",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#简单","aria-hidden":"true"},"#"),s(" 简单")],-1),k=n("h2",{id:"_21-合并两个有序链表",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_21-合并两个有序链表","aria-hidden":"true"},"#"),s(" 21.合并两个有序链表")],-1),i={class:"custom-container tip"},d=n("p",{class:"custom-container-title"},"TIP",-1),h=n("strong",null,"要求",-1),_=n("br",null,null,-1),m=n("strong",null,"输入",-1),w=n("br",null,null,-1),y=n("strong",null,"输出",-1),f=n("br",null,null,-1),v=n("strong",null,"原题链接",-1),g={href:"https://leetcode.cn/problems/merge-two-sorted-lists/",target:"_blank",rel:"noopener noreferrer"},b=p(`<p>方法一：递归</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// m和n分别为两个链表的长度</span>
