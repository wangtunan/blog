import{_ as t,r as p,o as e,c as o,e as c,a as n,b as s,d as l}from"./app-hs5NDrKZ.js";const r={},k=n("h1",{id:"简单",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#简单","aria-hidden":"true"},"#"),s(" 简单")],-1),u=n("h2",{id:"_35-搜索插入位置",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_35-搜索插入位置","aria-hidden":"true"},"#"),s(" 35.搜索插入位置")],-1),i=l(`<p>方法：二分查找</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// n为数组元素的数量</span>
