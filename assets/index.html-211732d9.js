import{_ as i,r as o,o as c,c as l,a as s,b as a,e as n,F as u,f as k,t as d,d as t}from"./app-e999ad96.js";const g="/blog/assets/1-d5ef3e36.png",h="/blog/assets/2-f8b464c6.png",m="/blog/assets/3-d0ea9c33.png",y="/blog/assets/20-cc59a4b7.png",v="/blog/assets/4-bb258abc.png",x="/blog/assets/5-d24d4e55.png",b="/blog/assets/6-6b78a16c.png",f="/blog/assets/9-17429043.png",j="/blog/assets/10-f5b2edf9.png",_="/blog/assets/11-14dda920.png",w="/blog/assets/12-1f60e0ec.png",V="/blog/assets/13-75401e06.png",S="/blog/assets/7-1d5afda0.png",q="/blog/assets/8-70c467d1.png",C="/blog/assets/14-a54ca368.png",P="/blog/assets/15-c6bcd2a5.png",E="/blog/assets/16-5e06becd.png",L="/blog/assets/17-e4a8ebb7.png",M="/blog/assets/18-8ca5d09c.png",A="/blog/assets/19-2ab2e3d2.png",T={},B={id:"vuepress",tabindex:"-1"},$=s("a",{class:"header-anchor",href:"#vuepress","aria-hidden":"true"},"#",-1),H=s("code",null,"blog",-1),J=s("code",null,"blog",-1),D={href:"https://github.com/wangtunan/vuepress-blog-demo",target:"_blank",rel:"noopener noreferrer"},I=t(`<h2 id="介绍" tabindex="-1"><a class="header-anchor" href="#介绍" aria-hidden="true">#</a> 介绍</h2><h3 id="如何而来" tabindex="-1"><a class="header-anchor" href="#如何而来" aria-hidden="true">#</a> 如何而来</h3><p>VuePress 是一个<strong>静态网站生成器</strong>，使用它我们一方面可以专注输出技术类文档，也可以使用基于Vue的开发方式来开发我们其它的静态网站。<br> 每一个由 VuePress 生成的静态页面都是经过服务端渲染(SSR)而来，因此由 VuePress 生成的页面在加载性能和搜索引擎优化(SEO)上有很明显的优势。</p><h3 id="组成部分" tabindex="-1"><a class="header-anchor" href="#组成部分" aria-hidden="true">#</a> 组成部分</h3><p>通常而言，一个由 VuePress 生成的网站，它是用<code>Vue</code>、<code>Vue-router</code>、<code>Webpack</code>以及利用服务端渲染(<code>SSR</code>)而来，它不仅支持 Vue 组件的写法，还内置 <code>Stylus</code> 语法。</p><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><div class="custom-container warning"><p class="custom-container-title">注意</p><p>本博客VuePress主版本为<code>0.x</code>，相关配置最新的<code>1.x</code>也兼容，请放心使用。另请确认你的Node.js &gt;= 8</p></div><h3 id="全局安装-推荐" tabindex="-1"><a class="header-anchor" href="#全局安装-推荐" aria-hidden="true">#</a> 全局安装(推荐)</h3><p>通常而言，全局安装 VuePress 会非常省心，可以通过如下命令进行全局安装</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code>$ <span class="token function">npm</span> <span class="token function">install</span> <span class="token parameter variable">-g</span> vuepress
...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><p>配置后，代码块行号的结果如下图所示</p><p><img src="`+f+'" alt="代码块行号"></p><h3 id="使用emoji表情" tabindex="-1"><a class="header-anchor" href="#使用emoji表情" aria-hidden="true">#</a> 使用Emoji表情</h3><div class="custom-container warning"><p class="custom-container-title">注意</p><p>并不是所有<code>Emoji</code>表情都支持</p></div>',144),R=s("code",null,".md",-1),N=s("code",null,"Emoji",-1),G={href:"https://emoji.muan.co/",target:"_blank",rel:"noopener noreferrer"},W=s("code",null,"Emoji",-1),Y={href:"https://gitmoji.carloscuesta.me/",target:"_blank",rel:"noopener noreferrer"},O=s("code",null,"Emoji",-1),U=s("code",null,"Emoji",-1),F=t(`<div class="language-markdown" data-ext="md"><pre class="language-markdown"><code><span class="token title important"><span class="token punctuation">####</span> 这里是Emoji表情 :tada:</span>
:100: :rocket:
...
</code></pre></div>`,16),K=s("code",null,"OutboundLink",-1),X={href:"https://www.baidu.com",target:"_blank",rel:"noopener noreferrer"},Q=t(`<h4 id="badge-角标" tabindex="-1"><a class="header-anchor" href="#badge-角标" aria-hidden="true">#</a> Badge(角标)</h4><div class="custom-container tip"><p class="custom-container-title">说明</p><p>内置组件<code>Badge</code>有三个属性需要传递：</p><ul><li><code>text</code>：它指明了角标的内容</li><li><code>type</code>：同自定义容器类似，它有三种不同的类型，分别是<code>tip</code>、<code>warn</code>和<code>error</code>，默认是<code>tip</code></li><li><code>vertical</code>：它指明了角标同内容的对齐方式，有两个值，分别是<code>top</code>和<code>middle</code>，默认是<code>top</code></li></ul></div><p>角标的使用如下所示</p><div class="language-markdown" data-ext="md"><pre class="language-markdown"><code><span class="token title important"><span class="token punctuation">####</span> Vue &lt;Badge text=&quot;2.5.0+&quot;/&gt; </span>
...
</code></pre></div><p>VuePress 运行结果</p><p><img src="`+V+`" alt="VuePress运行结果"></p><h2 id="进阶配置" tabindex="-1"><a class="header-anchor" href="#进阶配置" aria-hidden="true">#</a> 进阶配置</h2><h3 id="基本配置api" tabindex="-1"><a class="header-anchor" href="#基本配置api" aria-hidden="true">#</a> 基本配置API</h3><h4 id="title-标题" tabindex="-1"><a class="header-anchor" href="#title-标题" aria-hidden="true">#</a> title(标题)</h4><div class="custom-container tip"><p class="custom-container-title">说明</p><p><code>title</code>标题能让我们配置静态站点的标题，它固定在我们顶部左上角</p></div><p>可以像下面这样来配置<code>title</code></p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  <span class="token comment">// 其它配置</span>
...
<span class="token punctuation">}</span>
</code></pre></div><p>配置后的结果如下图所示</p><p><img src="`+S+`" alt="title配置结果"></p><h4 id="description-网站的描述" tabindex="-1"><a class="header-anchor" href="#description-网站的描述" aria-hidden="true">#</a> description(网站的描述)</h4><div class="custom-container tip"><p class="custom-container-title">说明</p><p><code>description</code>它将会以 <code>&lt;meta&gt;</code> 标签渲染到当前页面的 HTML 中，它是给搜索引擎去识别的，这属于<code>SEO</code>配置</p></div><p>可以像下面这样配置<code>description</code></p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  <span class="token comment">// 其它配置</span>
...
<span class="token punctuation">---</span>
</code></pre></div><p>使用自定义样式它的结果</p><p><img src="`+L+`" alt="自定义样式的结果"></p><h3 id="自定义页面布局" tabindex="-1"><a class="header-anchor" href="#自定义页面布局" aria-hidden="true">#</a> 自定义页面布局</h3><p>在默认主题下，每一个<code>.md</code>文件都会被渲染在<code>&lt;div class=&quot;page&quot;&gt;&lt;/div&gt;</code>这样的一个标签中，同时生成页面的侧边栏、编辑链接(如果有)、最新更新时间(如果有)以及上一篇/下一篇(如果有)。<br> 但是如果我们不想生成这样的页面，而是想使用自定义布局，也就是使用<code>Vue</code>组件来进行自定义页面开发，VuePress提供给了我们这样的能力，它在<strong>保留导航栏</strong>的基础上，其它一切我们都可以自定义的，它的配置可能是这样的</p><div class="language-yaml" data-ext="yml"><pre class="language-yaml"><code>// 在需要自定义的.md文件中使用YAML语法
<span class="token punctuation">---</span>
...
</code></pre></div><p>在提交成功后，可以通过<code>https://xxx.github.io</code>或者<code>https://xxx.github.io/xxx/</code>进行访问</p><div class="custom-container warning"><p class="custom-container-title">提醒</p><p>关于自动化部署，如果你是新手，那么按照正常的流程提交代码到远程仓库即可，不建议新手使用自动化部署。</p></div>`,58);function is(us,ks){const e=o("Badge"),p=o("ExternalLinkIcon");return c(),l("div",null,[s("h1",B,[$,a(" VuePress "),n(e,{text:"0.x"})]),s("p",null,[a("本"),H,a("配套了一个基于 VuePress 的一个简单的配置案例，此配置案例包含了本"),J,a("绝大部分配置案例，更多详情请移步这里"),s("a",D,[a("VuePress配置案例"),n(p)])]),I,s("p",null,[a("在"),R,a("文件中，我们可以使用"),N,a("表情，你也可以访问"),s("a",G,[a("Emoji Search"),n(p)]),a("来查询你喜欢的"),W,a("表情，访问"),s("a",Y,[a("Common Emoji"),n(p)]),a("来访问常用的"),O,a("，一个"),U,a("可以是这样写的")]),F,s("p",null,[a("列表渲染的结果是："),(c(),l(u,null,k(5,r=>s("span",null,d(r),1)),64))]),z,s("p",null,[a("此时，百度一下文字后面的小图标就是内置组件"),K,s("a",X,[a("百度一下"),n(p)])]),Q,s("h4",Z,[ss,a(" Vue "),n(e,{text:"2.5.0+"})]),s("h4",as,[ns,a(" Vuex "),n(e,{text:"beta",type:"warn",vertical:"top"})]),s("h4",ts,[ps,a(" Vue-Resource"),n(e,{text:"废弃",vertical:"middle",type:"error"})]),es,s("p",null,[a("此小结的配置由于特殊性，并没有配置成功，如果你感兴趣，请移步这里👉"),s("a",os,[a("Algolia搜索"),n(p)]),cs,a(" 如果你配置成功了，它们的搜索效果会是下面这样子的("),ls,a(")")]),rs])}const gs=i(T,[["render",is],["__file","index.html.vue"]]);export{gs as default};
