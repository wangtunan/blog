import{_ as s,o as a,c as n,d as o}from"./app-87212aaa.js";const e={},t=o(`<h1 id="配置package-json" tabindex="-1"><a class="header-anchor" href="#配置package-json" aria-hidden="true">#</a> 配置package.json</h1><p>我们需要在<code>package.json</code>中配置如下信息：</p><div class="language-json" data-ext="json"><pre class="language-json"><code><span class="token comment">// package.json文件</span>
...
</code></pre></div>`,6),p=[t];function c(r,l){return a(),n("div",null,p)}const u=s(e,[["render",c],["__file","index.html.vue"]]);export{u as default};
