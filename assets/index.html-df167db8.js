import{_ as o,r as e,o as c,c as l,e as s,a,b as p,d as t}from"./app-aa72ee8f.js";const u={},k=a("h1",{id:"中等",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#中等","aria-hidden":"true"},"#"),p(" 中等")],-1),r=a("h2",{id:"_33-搜索旋转排序数组",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#_33-搜索旋转排序数组","aria-hidden":"true"},"#"),p(" 33.搜索旋转排序数组")],-1),i=t(`<p>方法一：分别找行和列</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// m为二维矩阵的行数、n为二维矩阵的列数</span>
...
<span class="token punctuation">}</span>
</code></pre></div><h2 id="_34-在排序数组中查找元素的第一个和最后一个位置" tabindex="-1"><a class="header-anchor" href="#_34-在排序数组中查找元素的第一个和最后一个位置" aria-hidden="true">#</a> 34.在排序数组中查找元素的第一个和最后一个位置</h2>`,5),d=t(`<div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// n为数组的元素长度</span>
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre></div><h2 id="_74-搜索二维矩阵" tabindex="-1"><a class="header-anchor" href="#_74-搜索二维矩阵" aria-hidden="true">#</a> 74.搜索二维矩阵</h2>`,2),m=t(`<div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// n为数组元素的数量</span>
<span class="token comment">// 时间复杂度：O(logn)</span>
<span class="token comment">// 空间复杂度：O(1)</span>
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre></div><h2 id="_153-寻找旋转排序数组中的最小值" tabindex="-1"><a class="header-anchor" href="#_153-寻找旋转排序数组中的最小值" aria-hidden="true">#</a> 153.寻找旋转排序数组中的最小值</h2>`,2),w=t(`<div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// n为数组元素数量</span>
<span class="token comment">// 时间复杂度：O(logn)</span>
<span class="token comment">// 空间复杂度：O(1)</span>
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre></div>`,1);function g(h,f){const n=e("leetcode-link");return c(),l("div",null,[k,r,s(n,{title:"33.搜索旋转排序数组",link:"https://leetcode.cn/problems/search-in-rotated-sorted-array"}),i,s(n,{title:"34.在排序数组中查找元素的第一个和最后一个位置",link:"https://leetcode.cn/problems/find-first-and-last-position-of-element-in-sorted-array"}),d,s(n,{title:"74.搜索二维矩阵",link:"https://leetcode.cn/problems/search-a-2d-matrix"}),m,s(n,{title:"153.寻找旋转排序数组中的最小值",link:"https://leetcode.cn/problems/find-minimum-in-rotated-sorted-array"}),w])}const b=o(u,[["render",g],["__file","index.html.vue"]]);export{b as default};
