import{_ as n,o as a,c as p,d as o}from"./app-d99c486e.js";const t={};function e(c,s){return a(),p("div",null,s[0]||(s[0]=[o(`<h1 id="基础配置" tabindex="-1"><a class="header-anchor" href="#基础配置" aria-hidden="true">#</a> 基础配置</h1><p>在开始之前，我们需要新建一个项目，并且创建一些必要的文件目录，如下：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">|</span>-- rollup-learn
