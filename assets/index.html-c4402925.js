import{_ as s,o as n,c as a,d as p}from"./app-efbb9da8.js";const o={},t=p(`<h1 id="基础配置" tabindex="-1"><a class="header-anchor" href="#基础配置" aria-hidden="true">#</a> 基础配置</h1><p>在开始之前，我们需要新建一个项目，并且创建一些必要的文件目录，如下：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">|</span>-- rollup-learn
...
</code></pre></div><p>这样，我们的基础目录已经有了，在之后的小节中，所有案例均基于这个基础的目录结构。</p>`,19),e=[t];function c(l,r){return n(),a("div",null,e)}const i=s(o,[["render",c],["__file","index.html.vue"]]);export{i as default};
