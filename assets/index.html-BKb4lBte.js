...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"></div></div><p>输出结果：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">密集嵌入维度: (1024,)</span>
...
<span class="line">]</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"></div></div>`,13)]))}const i=s(t,[["render",l]]),u=JSON.parse('{"path":"/rag/embedding/dense/","title":"密集嵌入","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1748265568000,"contributors":[{"name":"wangtunan","username":"wangtunan","email":"why583440138@gmail.com","commits":1,"url":"https://github.com/wangtunan"}],"changelog":[{"hash":"52eefd799cbc72037e3928a0ff74fcbc4d121874","time":1748265568000,"email":"why583440138@gmail.com","author":"wangtunan","message":"blog RAG结构化文档Embedding文章撰写"}]},"filePathRelative":"rag/embedding/dense/README.md"}');export{i as comp,u as data};
