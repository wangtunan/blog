import{_ as n,o as a,c as t,d as s}from"./app-c3fd65b6.js";const o={},e=s(`<h1 id="go基础" tabindex="-1"><a class="header-anchor" href="#go基础" aria-hidden="true">#</a> Go基础</h1><h2 id="约定规则" tabindex="-1"><a class="header-anchor" href="#约定规则" aria-hidden="true">#</a> 约定规则</h2><p>Go中有一些约定的规则：</p><ul><li>每个<code>.go</code>文件必须有一个包名，例如<code>package main</code>，其中<code>main</code>即为包名。</li><li>严格区分大小写，大写开头的变量、常量或者方法可跨包访问。</li><li>双引号代表字符串，单引号代表字符，例如：<code>&quot;abc&quot;</code>和<code>&#39;a&#39;</code>。</li><li>不需要写分号。</li></ul><h2 id="注释" tabindex="-1"><a class="header-anchor" href="#注释" aria-hidden="true">#</a> 注释</h2><div class="language-go" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> main
...
<span class="token punctuation">}</span>
</code></pre></div><h2 id="fmt格式字符" tabindex="-1"><a class="header-anchor" href="#fmt格式字符" aria-hidden="true">#</a> fmt格式字符</h2><table><thead><tr><th>符号</th><th>类型</th><th>含义</th><th>说明</th></tr></thead><tbody><tr><td>%%</td><td>通用</td><td>%</td><td>输出百分号(%)</td></tr><tr><td>%v</td><td>通用</td><td>value</td><td>输出value值</td></tr><tr><td>%T</td><td>通用</td><td>Type</td><td>输出值对应的类型</td></tr><tr><td>%p</td><td>通用</td><td>Pointer</td><td>0x开头的16进制指针地址</td></tr><tr><td>%d</td><td>整数</td><td>decimal</td><td>十进制</td></tr><tr><td>%b</td><td>整数</td><td>binary</td><td>二进制(没有前缀)</td></tr><tr><td>%o</td><td>整数</td><td>octal</td><td>八进制(没有前缀)</td></tr><tr><td>%x</td><td>整数</td><td>hexadecimal</td><td>十六进制a-f(没有前缀)</td></tr><tr><td>%X</td><td>整数</td><td>hexadecimal</td><td>十六进制A-F(没有前缀)</td></tr><tr><td>%c</td><td>整数</td><td>character</td><td>Unicode码值对应的字符</td></tr><tr><td>%f或者%F</td><td>浮点数</td><td>float</td><td>小数</td></tr><tr><td>%.xf</td><td>浮点数</td><td>float</td><td>保留x位小数，不足位数补0</td></tr><tr><td>%e</td><td>浮点数</td><td>float</td><td>小写e的科学计数法</td></tr><tr><td>%E</td><td>浮点数</td><td>float</td><td>大写e的科学计数法</td></tr><tr><td>%t</td><td>布尔值</td><td>bool</td><td>输出true或者false</td></tr><tr><td>%s</td><td>字符串</td><td>string</td><td>按字符串输出</td></tr><tr><td>%q</td><td>字符串</td><td>string</td><td>带引号的字符串输出</td></tr></tbody></table><h2 id="运算符" tabindex="-1"><a class="header-anchor" href="#运算符" aria-hidden="true">#</a> 运算符</h2><h2 id="流程控制语句" tabindex="-1"><a class="header-anchor" href="#流程控制语句" aria-hidden="true">#</a> 流程控制语句</h2><h2 id="函数" tabindex="-1"><a class="header-anchor" href="#函数" aria-hidden="true">#</a> 函数</h2><h2 id="数组和切片" tabindex="-1"><a class="header-anchor" href="#数组和切片" aria-hidden="true">#</a> 数组和切片</h2><h2 id="map" tabindex="-1"><a class="header-anchor" href="#map" aria-hidden="true">#</a> map</h2><h2 id="结构体和自定义数据类型" tabindex="-1"><a class="header-anchor" href="#结构体和自定义数据类型" aria-hidden="true">#</a> 结构体和自定义数据类型</h2><h2 id="方法和接口" tabindex="-1"><a class="header-anchor" href="#方法和接口" aria-hidden="true">#</a> 方法和接口</h2><h2 id="协程-channel" tabindex="-1"><a class="header-anchor" href="#协程-channel" aria-hidden="true">#</a> 协程/channel</h2>`,64),p=[e];function c(d,l){return a(),t("div",null,p)}const u=n(o,[["render",c],["__file","index.html.vue"]]);export{u as default};
