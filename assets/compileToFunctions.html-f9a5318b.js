import{_ as o,r as e,o as c,c as l,a as n,b as s,e as p,d as t}from"./app-4e2da491.js";const u={},i=t(`<h1 id="compiletofunctions" tabindex="-1"><a class="header-anchor" href="#compiletofunctions" aria-hidden="true">#</a> compileToFunctions</h1><h2 id="compile核心方法" tabindex="-1"><a class="header-anchor" href="#compile核心方法" aria-hidden="true">#</a> compile核心方法</h2><p>我们知道，在<code>runtime + compiler</code>的版本中，<code>$mount</code>方法和<code>Vue.compile</code>全局<code>API</code>都用到了<code>compileToFunctions</code>方法。在<code>Web</code>平台下，它是从<code>src/platforms/web/compiler/index.js</code>文件中引入的，代码如下：</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> baseOptions <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;./options&#39;</span>
