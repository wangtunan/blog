...
</code></pre></div><p>在以上代码中，我们发现它引入了<code>Vue</code>随后调用了<code>initGlobalAPI()</code>函数，此函数的作用是挂载一些全局<code>API</code>方法。</p><p><img src="`+p+`" alt="initGlobalAPI"></p><p>我们首先能在<code>src/core/global-api</code>文件夹下看到如下目录结构：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">|</span>-- global-api        
...
<span class="token keyword">export</span> <span class="token keyword">default</span> Vue
</code></pre></div><p>根据<code>initGlobalAPI()</code>方法的逻辑，可以得到如下流程图： <img src="`+o+'" alt="initGlobalAPI流程图"></p>',16),i=[c];function l(u,k){return s(),a("div",null,i)}const d=n(e,[["render",l],["__file","global.html.vue"]]);export{d as default};
