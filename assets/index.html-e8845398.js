import{_ as p,r as t,o,c as e,e as c,a as n,b as s,d as u}from"./app-2b83b1b9.js";const l={},k=n("h1",{id:"困难",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#困难","aria-hidden":"true"},"#"),s(" 困难")],-1),r=n("h2",{id:"_4-寻找两个正序数组的中位数",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_4-寻找两个正序数组的中位数","aria-hidden":"true"},"#"),s(" 4.寻找两个正序数组的中位数")],-1),i=u(`<p>方法一：暴力合并数组</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// m，n分别为两个数组的元素数量</span>
