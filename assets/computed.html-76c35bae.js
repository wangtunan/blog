import{_ as n,o as s,c as a,d as t}from"./app-9fa24cce.js";const p="/blog/assets/computed-7d15fd01.png",o={},e=t(`<h1 id="computed处理" tabindex="-1"><a class="header-anchor" href="#computed处理" aria-hidden="true">#</a> computed处理</h1><p>处理<code>computed</code>相关的逻辑，发生在<code>initState</code>中，接下来我们详细分析与<code>computed</code>相关的逻辑。</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">export</span> <span class="token keyword">function</span> <span class="token function">initState</span> <span class="token punctuation">(</span><span class="token parameter"><span class="token literal-property property">vm</span><span class="token operator">:</span> Component</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
