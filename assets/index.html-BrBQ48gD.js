import{_ as s,c as a,b as p,o as t}from"./app-BKxGWABj.js";const o={};function e(l,n){return t(),a("div",null,n[0]||(n[0]=[p(`<h1 id="json" tabindex="-1"><a class="header-anchor" href="#json"><span>JSON</span></a></h1><div class="hint-container tip"><p class="hint-container-title">提示</p><p><a href="https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.json_loader.JSONLoader.html" target="_blank" rel="noopener noreferrer">JSONLoader文档</a></p></div><p><code>JSON</code>格式的数据也可以使用<code>TextLoader</code>来加载，但与<code>JSONLoader</code>相比，它有以下两大缺点：</p><ul><li>加载出来的只是纯文本，不包含格式。</li><li>只能加载全部内容，不能指定某个字段。</li></ul><details><summary>原始JSON内容：</summary><div class="language-json line-numbers-mode" data-highlighter="prismjs" data-ext="json"><pre><code class="language-json"><span class="line"><span class="token punctuation">{</span></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"></div></div><h2 id="使用jsonloader加载对象字段" tabindex="-1"><a class="header-anchor" href="#使用jsonloader加载对象字段"><span>使用JSONLoader加载对象字段</span></a></h2><div class="hint-container tip"><p class="hint-container-title">提示</p><p>安装依赖包<code>pip install jq</code></p></div><div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token keyword">import</span> json</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"></div></div><p>输出结果：</p><div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token punctuation">[</span></span>
...
<span class="line">  <span class="token punctuation">)</span></span>
<span class="line"><span class="token punctuation">]</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"></div></div>`,17)]))}const u=s(o,[["render",e]]),i=JSON.parse('{"path":"/rag/loader/json/","title":"JSON","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1748265568000,"contributors":[{"name":"wangtunan","username":"wangtunan","email":"why583440138@gmail.com","commits":1,"url":"https://github.com/wangtunan"}],"changelog":[{"hash":"52eefd799cbc72037e3928a0ff74fcbc4d121874","time":1748265568000,"email":"why583440138@gmail.com","author":"wangtunan","message":"blog RAG结构化文档Embedding文章撰写"}]},"filePathRelative":"rag/loader/json/README.md"}');export{u as comp,i as data};
