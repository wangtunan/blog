import{_ as e,r as c,o as u,c as l,a as p,b as o,e as a,d as t}from"./app-c9515a38.js";const k={};function i(r,n){const s=c("leetcode-link");return u(),l("div",null,[n[0]||(n[0]=p("h1",{id:"简单",tabindex:"-1"},[p("a",{class:"header-anchor",href:"#简单","aria-hidden":"true"},"#"),o(" 简单")],-1)),n[1]||(n[1]=p("h2",{id:"_94-二叉树的中序遍历",tabindex:"-1"},[p("a",{class:"header-anchor",href:"#_94-二叉树的中序遍历","aria-hidden":"true"},"#"),o(" 94.二叉树的中序遍历")],-1)),a(s,{title:"94.二叉树的中序遍历",link:"https://leetcode.cn/problems/binary-tree-inorder-traversal"}),n[2]||(n[2]=t(`<p>方法一：递归</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// n为二叉树节点的数量</span>
