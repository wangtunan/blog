import{_ as a,o as n,c as o,d as e}from"./app-d99c486e.js";const p={};function t(c,s){return n(),o("div",null,s[0]||(s[0]=[e(`<h1 id="配置package-json" tabindex="-1"><a class="header-anchor" href="#配置package-json" aria-hidden="true">#</a> 配置package.json</h1><p>我们需要在<code>package.json</code>中配置如下信息：</p><div class="language-json" data-ext="json"><pre class="language-json"><code><span class="token comment">// package.json文件</span>
