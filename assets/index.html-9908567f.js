...
</code></pre></div>`,5),u=s("code",null,"Rollup",-1),i=s("code",null,"plugins",-1),k={href:"https://github.com/rollup/plugins",target:"_blank",rel:"noopener noreferrer"};function m(g,f){const o=e("ExternalLinkIcon");return p(),c("div",null,[d,s("p",null,[n("以上仅列举最常见的插件，"),u,n("维护了很多其它"),i,n("，你可点击"),s("a",k,[n("Rollup官方插件列表"),t(o)]),n("查看更多内容。")])])}const b=a(r,[["render",m],["__file","index.html.vue"]]);export{b as default};
