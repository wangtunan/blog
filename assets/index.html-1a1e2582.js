import{_ as n,o as s,c as a,d as p}from"./app-87212aaa.js";const t={},o=p(`<h1 id="支持typescript" tabindex="-1"><a class="header-anchor" href="#支持typescript" aria-hidden="true">#</a> 支持TypeScript</h1><p>如果要支持<code>TypeScript</code>，需要安装几个<code>npm</code>包，如下：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 安装rollup插件和其依赖包</span>
...
</code></pre></div>`,11),e=[o];function c(l,u){return s(),a("div",null,e)}const i=n(t,[["render",c],["__file","index.html.vue"]]);export{i as default};
