...
<span class="line">==================================================</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"></div></div>`,18)]))}const i=s(e,[["render",l]]),u=JSON.parse('{"path":"/rag/chunking/methods/","title":"分块方法","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1748621635000,"contributors":[{"name":"wangtunan","username":"wangtunan","email":"why583440138@gmail.com","commits":1,"url":"https://github.com/wangtunan"}],"changelog":[{"hash":"c00d4c07f16aa3d077f28506bfb6e7ed5e88337f","time":1748621635000,"email":"why583440138@gmail.com","author":"wangtunan","message":"blog RAG结构化文档向量存储文章撰写"}]},"filePathRelative":"rag/chunking/methods/README.md"}');export{i as comp,u as data};
