...
<span class="line">==================================================</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"></div></div>`,18)]))}const i=s(e,[["render",l]]),u=JSON.parse('{"path":"/rag/chunking/methods/","title":"分块方法","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1748268517000,"contributors":[{"name":"wangtunan","username":"wangtunan","email":"why583440138@gmail.com","commits":1,"url":"https://github.com/wangtunan"}],"changelog":[{"hash":"0b90fcc3c46debc8bd64d613b8d19e667b7024a8","time":1748268517000,"email":"why583440138@gmail.com","author":"wangtunan","message":"blog RAG结构化文档向量文章撰写"}]},"filePathRelative":"rag/chunking/methods/README.md"}');export{i as comp,u as data};
