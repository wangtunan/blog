import{_ as t,r as o,o as e,c,a as s,b as a,e as u,d as l}from"./app-c9515a38.js";const k={};function r(i,n){const p=o("leetcode-link");return e(),c("div",null,[n[0]||(n[0]=s("h1",{id:"困难",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#困难","aria-hidden":"true"},"#"),a(" 困难")],-1)),n[1]||(n[1]=s("h2",{id:"_4-寻找两个正序数组的中位数",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#_4-寻找两个正序数组的中位数","aria-hidden":"true"},"#"),a(" 4.寻找两个正序数组的中位数")],-1)),u(p,{title:"4.寻找两个正序数组的中位数",link:"https://leetcode.cn/problems/median-of-two-sorted-arrays"}),n[2]||(n[2]=l(`<p>方法一：暴力合并数组</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// m，n分别为两个数组的元素数量</span>
