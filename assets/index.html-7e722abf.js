import{_ as o,o as a,c as s,d as c}from"./app-d99c486e.js";const n={};function r(p,e){return a(),s("div",null,e[0]||(e[0]=[c(`<h1 id="源码目录" tabindex="-1"><a class="header-anchor" href="#源码目录" aria-hidden="true">#</a> 源码目录</h1><p>因为<code>Vue3</code>采用<code>Monorepo</code>进行项目代码管理，所以我们着重关注<code>packages</code>目录，其中比较关键的几个<code>package</code>如下：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">|</span>-- packages            
