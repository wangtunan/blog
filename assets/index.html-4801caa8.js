import{_ as s,o as n,c as a,d as t}from"./app-4d1df267.js";const e={},p=t(`<h1 id="支持jest自动化测试" tabindex="-1"><a class="header-anchor" href="#支持jest自动化测试" aria-hidden="true">#</a> 支持Jest自动化测试</h1><p>如果需要支持<code>Jest</code>自动化测试，需要我们安装额外的<code>npm</code>包：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 安装jest</span>
