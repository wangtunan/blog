import{_ as n,o as s,c as a,d as p}from"./app-0688004a.js";const t={},o=p(`<h1 id="前置核心概念" tabindex="-1"><a class="header-anchor" href="#前置核心概念" aria-hidden="true">#</a> 前置核心概念</h1><h2 id="object-defineproperty介绍" tabindex="-1"><a class="header-anchor" href="#object-defineproperty介绍" aria-hidden="true">#</a> Object.defineProperty介绍</h2><p>也许你已经从很多地方了解到，<code>Vue.js</code>利用了<code>Object.defineProperty(obj, key, descriptor)</code>方法来实现响应式，其中<code>Object.defineProperty()</code>方法的参数介绍如下：</p><ul><li><code>obj</code>：要定义其属性的对象。</li><li><code>key</code>：要定义或修改属性的名称。</li><li><code>descriptor</code>：要定义或修改属性的描述符。</li></ul><p>其中<code>descriptor</code>有很多可选的键值， 然而对<code>Vue</code>响应式来说最重要的是<code>get</code>和<code>set</code>方法，它们分别会在获取属性值的时候触发<code>getter</code>，设置属性值的时候触发<code>setter</code>。在介绍原理之前，我们使用<code>Object.defineProperty()</code>来实现一个简单的响应式例子：</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">defineReactive</span> <span class="token punctuation">(</span><span class="token parameter">obj<span class="token punctuation">,</span> key<span class="token punctuation">,</span> val</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
