import{_ as e}from"./python-vscode-6630e1d3.js";import{_ as c,r as l,o as u,c as k,a as s,b as a,e as t,d as o}from"./app-d99c486e.js";const i={},r={href:"https://docs.python.org/zh-cn/3.13/",target:"_blank",rel:"noopener noreferrer"},d={href:"https://pypi.org/",target:"_blank",rel:"noopener noreferrer"},m={href:"https://docs.conda.io/projects/conda/en/stable/",target:"_blank",rel:"noopener noreferrer"},y={href:"https://www.anaconda.com/docs/main",target:"_blank",rel:"noopener noreferrer"},h={class:"custom-container tip"},g={href:"https://pypi.org/",target:"_blank",rel:"noopener noreferrer"};function b(w,n){const p=l("ExternalLinkIcon");return u(),k("div",null,[n[7]||(n[7]=s("h1",{id:"python快速入门",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#python快速入门","aria-hidden":"true"},"#"),a(" Python快速入门")],-1)),n[8]||(n[8]=s("h2",{id:"文档",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#文档","aria-hidden":"true"},"#"),a(" 文档")],-1)),s("ul",null,[s("li",null,[s("a",r,[n[0]||(n[0]=a("官方文档")),t(p)])]),s("li",null,[s("a",d,[n[1]||(n[1]=a("第三方库")),t(p)])]),s("li",null,[s("a",m,[n[2]||(n[2]=a("Conda")),t(p)])]),s("li",null,[s("a",y,[n[3]||(n[3]=a("Miniconda")),t(p)])])]),n[9]||(n[9]=o('<h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><ul><li>Python：推荐安装v3.10+版本，以下所有代码示例均基于Python@3.10+。</li><li>Conda：推荐安装Miniconda。</li></ul><h2 id="vscode插件" tabindex="-1"><a class="header-anchor" href="#vscode插件" aria-hidden="true">#</a> VSCode插件</h2><p><img src="'+e+`" alt="python VSCode插件"></p><h2 id="虚拟环境" tabindex="-1"><a class="header-anchor" href="#虚拟环境" aria-hidden="true">#</a> 虚拟环境</h2><p>强烈建议任何时候都通过类似<code>Conda</code>这样的工具创建一个虚拟环境并指定<code>Python</code>版本。</p><div class="language-python" data-ext="py"><pre class="language-python"><code><span class="token comment"># 规则</span>
...
</code></pre></div><h3 id="第三方模块" tabindex="-1"><a class="header-anchor" href="#第三方模块" aria-hidden="true">#</a> 第三方模块</h3>`,85)),s("div",h,[n[6]||(n[6]=s("p",{class:"custom-container-title"},"TIP",-1)),s("p",null,[n[5]||(n[5]=a("第三方模块包地址：")),s("a",g,[n[4]||(n[4]=a("https://pypi.org/")),t(p)])])]),n[10]||(n[10]=o(`<p>第三方模块需要安装，安装后才能使用。</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code>$ pip <span class="token function">install</span> pandas
...
</code></pre></div>`,20))])}const q=c(i,[["render",b],["__file","index.html.vue"]]);export{q as default};
