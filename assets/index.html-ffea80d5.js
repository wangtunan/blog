import{_ as o,r as e,o as c,c as l,e as s,a,b as p,d as t}from"./app-e5c00fe0.js";const u={},k=a("h1",{id:"中等",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#中等","aria-hidden":"true"},"#"),p(" 中等")],-1),r=a("h2",{id:"_33-搜索旋转排序数组",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#_33-搜索旋转排序数组","aria-hidden":"true"},"#"),p(" 33.搜索旋转排序数组")],-1),i=t(`<p>方法一：分别找行和列</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// m为二维矩阵的行数、n为二维矩阵的列数</span>
