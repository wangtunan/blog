import{_ as p,r as o,o as e,c,a as s,b as a,e as l,d as r}from"./app-6a641452.js";const k={};function u(i,n){const t=o("leetcode-link");return e(),c("div",null,[n[0]||(n[0]=s("h1",{id:"简单",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#简单","aria-hidden":"true"},"#"),a(" 简单")],-1)),n[1]||(n[1]=s("h2",{id:"_35-搜索插入位置",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#_35-搜索插入位置","aria-hidden":"true"},"#"),a(" 35.搜索插入位置")],-1)),l(t,{title:"35.搜索插入位置",link:"https://leetcode.cn/problems/search-insert-position"}),n[2]||(n[2]=r(`<p>方法：二分查找</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// n为数组元素的数量</span>
