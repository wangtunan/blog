import{_ as n,o as a,c as s,d as p}from"./app-582d7d65.js";const t={},o=p(`<h1 id="watch处理" tabindex="-1"><a class="header-anchor" href="#watch处理" aria-hidden="true">#</a> watch处理</h1><p>在介绍完处理<code>computed</code>相关的逻辑后，我们接下来看<code>watch</code>是如何处理的。</p><h2 id="watch初始化" tabindex="-1"><a class="header-anchor" href="#watch初始化" aria-hidden="true">#</a> watch初始化</h2><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">export</span> <span class="token keyword">function</span> <span class="token function">initState</span> <span class="token punctuation">(</span><span class="token parameter"><span class="token literal-property property">vm</span><span class="token operator">:</span> Component</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
