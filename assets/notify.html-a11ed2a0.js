...
</code></pre></div><h2 id="整体流程图" tabindex="-1"><a class="header-anchor" href="#整体流程图" aria-hidden="true">#</a> 整体流程图</h2><p>在分析完以上派发更新的过程后，我们可以得到如下流程图。</p><div style="text-align:center;"><img src="`+p+'" alt="派发更新流程"></div>',65),c=[e];function u(l,k){return s(),a("div",null,c)}const r=n(o,[["render",u],["__file","notify.html.vue"]]);export{r as default};
