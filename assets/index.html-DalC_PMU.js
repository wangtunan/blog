import{_ as s,c as a,b as t,o as e}from"./app-BKxGWABj.js";const p={};function o(l,n){return e(),a("div",null,n[0]||(n[0]=[t(`<h1 id="简单文本导入" tabindex="-1"><a class="header-anchor" href="#简单文本导入"><span>简单文本导入</span></a></h1><h2 id="textloader" tabindex="-1"><a class="header-anchor" href="#textloader"><span>TextLoader</span></a></h2><div class="hint-container tip"><p class="hint-container-title">提示</p><p><a href="https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.text.TextLoader.html" target="_blank" rel="noopener noreferrer">TextLoader文档</a></p></div><div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token keyword">from</span> langchain_community<span class="token punctuation">.</span>document_loaders <span class="token keyword">import</span> TextLoader</span>
...
<span class="line">  )</span>
<span class="line">]</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"></div></div><h2 id="directoryloader" tabindex="-1"><a class="header-anchor" href="#directoryloader"><span>DirectoryLoader</span></a></h2><div class="hint-container tip"><p class="hint-container-title">提示</p><p><a href="https://python.langchain.com/api_reference/community/document_loaders/langchain_community.document_loaders.directory.DirectoryLoader.html" target="_blank" rel="noopener noreferrer">DirectoryLoader文档</a></p></div><p>可使用<code>DirectoryLoader</code>一次性加载某个目录下所有<code>txt</code>文件。</p><div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token keyword">from</span> langchain_community<span class="token punctuation">.</span>document_loaders <span class="token keyword">import</span> DirectoryLoader<span class="token punctuation">,</span> TextLoader</span>
<span class="line"></span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"></div></div><h2 id="unstructured" tabindex="-1"><a class="header-anchor" href="#unstructured"><span>Unstructured</span></a></h2><div class="hint-container tip"><p class="hint-container-title">提示</p><p><a href="https://docs.unstructured.io/open-source/introduction/quick-start" target="_blank" rel="noopener noreferrer">Unstructured 文档</a></p></div><p>如要在加载文档时有自定义要求，可使用<code>Unstructured</code>获取更多信息。</p><div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token keyword">from</span> unstructured<span class="token punctuation">.</span>partition<span class="token punctuation">.</span>text <span class="token keyword">import</span> partition_text</span>
<span class="line"></span>
...
<span class="line">  filename: 设定.txt</span>
<span class="line">  filetype: text/plain</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"></div></div>`,16)]))}const i=s(p,[["render",o]]),r=JSON.parse('{"path":"/rag/loader/text/","title":"简单文本导入","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1748265568000,"contributors":[{"name":"wangtunan","username":"wangtunan","email":"why583440138@gmail.com","commits":1,"url":"https://github.com/wangtunan"}],"changelog":[{"hash":"52eefd799cbc72037e3928a0ff74fcbc4d121874","time":1748265568000,"email":"why583440138@gmail.com","author":"wangtunan","message":"blog RAG结构化文档Embedding文章撰写"}]},"filePathRelative":"rag/loader/text/README.md"}');export{i as comp,r as data};
