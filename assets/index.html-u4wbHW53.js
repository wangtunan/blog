import{_ as e,c as o,a as s,e as p,b as t,r as c,o as l}from"./app-xSeFVFS1.js";const i={};function u(k,n){const a=c("leetcode-link");return l(),o("div",null,[n[0]||(n[0]=s("h1",{id:"困难",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#困难"},[s("span",null,"困难")])],-1)),n[1]||(n[1]=s("h2",{id:"_23-合并k个升序链表",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#_23-合并k个升序链表"},[s("span",null,"23.合并K个升序链表")])],-1)),p(a,{title:"23.合并K个升序链表",link:"https://leetcode.cn/problems/merge-k-sorted-lists"}),n[2]||(n[2]=t(`<p>基础：合并两个有序链表。</p><div class="language-javascript" data-highlighter="prismjs" data-ext="js"><pre><code class="language-javascript"><span class="line"><span class="token keyword">var</span> <span class="token function-variable function">mergeTwoLists</span> <span class="token operator">=</span> <span class="token keyword">function</span><span class="token punctuation">(</span><span class="token parameter">list1<span class="token punctuation">,</span> list2</span><span class="token punctuation">)</span> <span class="token punctuation">{</span></span>
