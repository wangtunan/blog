...
</code></pre></div><p>其中，<code>$mount</code>方法我们在组件化章节中已经单独介绍过了，在编译原理这一章节，我们将其分为<strong>parse模板解析</strong>、<strong>optimize优化</strong>和<strong>codegen代码生成</strong>这三个大步骤来深入学习其实现原理，也就是<code>compileToFunctions</code>方法的实现逻辑。</p>`,5),e=[o];function c(l,u){return s(),a("div",null,e)}const k=n(p,[["render",c],["__file","index.html.vue"]]);export{k as default};
