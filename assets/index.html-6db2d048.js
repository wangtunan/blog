import{_ as o,r as e,o as c,c as l,a as n,b as s,e as t,d as p}from"./app-a9d53e89.js";const u={},k=n("h1",{id:"中等",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#中等","aria-hidden":"true"},"#"),s(" 中等")],-1),r=n("h2",{id:"_2-两数相加",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_2-两数相加","aria-hidden":"true"},"#"),s(" 2.两数相加")],-1),i={class:"custom-container tip"},d=n("p",{class:"custom-container-title"},"TIP",-1),h=n("strong",null,"要求",-1),y=n("br",null,null,-1),w=n("strong",null,"输入",-1),m=n("br",null,null,-1),_=n("strong",null,"输出",-1),f=n("br",null,null,-1),v=n("strong",null,"解释",-1),g=n("br",null,null,-1),b=n("strong",null,"原题链接",-1),x={href:"https://leetcode.cn/problems/add-two-numbers/",target:"_blank",rel:"noopener noreferrer"},j=p(`<div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// m为l1链表的长度，n为l2链表的长度</span>
...
<span class="token punctuation">}</span>
</code></pre></div><h2 id="_19-删除链表的倒数第n个结点" tabindex="-1"><a class="header-anchor" href="#_19-删除链表的倒数第n个结点" aria-hidden="true">#</a> 19.删除链表的倒数第N个结点</h2>`,2),L={class:"custom-container tip"},N=n("p",{class:"custom-container-title"},"TIP",-1),O=n("strong",null,"要求",-1),P=n("br",null,null,-1),R=n("strong",null,"输入",-1),I=n("br",null,null,-1),T=n("strong",null,"输出",-1),U=n("br",null,null,-1),C=n("strong",null,"原题链接",-1),E={href:"https://leetcode.cn/problems/remove-nth-node-from-end-of-list/",target:"_blank",rel:"noopener noreferrer"},H=p(`<p>方法一：迭代计算出链表长度</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// n为链表的长度</span>
...
<span class="token punctuation">}</span>
</code></pre></div><h2 id="_146-lru缓存" tabindex="-1"><a class="header-anchor" href="#_146-lru缓存" aria-hidden="true">#</a> 146.LRU缓存</h2>`,5),wn={class:"custom-container tip"},mn=n("p",{class:"custom-container-title"},"TIP",-1),_n=n("strong",null,"要求",-1),fn=n("br",null,null,-1),vn=n("strong",null,"说明",-1),gn={href:"https://baike.baidu.com/item/LRU",target:"_blank",rel:"noopener noreferrer"},bn=n("br",null,null,-1),xn=n("strong",null,"原题链接",-1),jn={href:"https://leetcode.cn/problems/lru-cache",target:"_blank",rel:"noopener noreferrer"},Ln=p(`<div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">var</span> <span class="token function-variable function">LRUCache</span> <span class="token operator">=</span> <span class="token keyword">function</span><span class="token punctuation">(</span><span class="token parameter">capacity</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token class-name">LRUCache</span><span class="token punctuation">.</span>prototype<span class="token punctuation">.</span><span class="token function-variable function">put</span> <span class="token operator">=</span> <span class="token keyword">function</span><span class="token punctuation">(</span><span class="token parameter">key<span class="token punctuation">,</span> value</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">return</span> <span class="token keyword">null</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre></div><h2 id="_148-排序链表" tabindex="-1"><a class="header-anchor" href="#_148-排序链表" aria-hidden="true">#</a> 148.排序链表</h2>`,2);function Nn(On,Pn){const a=e("ExternalLinkIcon");return c(),l("div",null,[k,r,n("div",i,[d,n("p",null,[h,s("：给你两个非空的链表，表示两个非负的整数。它们每位数字都是按照逆序的方式存储的，并且每个节点只能存储一位数字。请你将两个数相加，并以相同形式返回一个表示和的链表。"),y,w,s("：l1 = [2, 4, 3], l2 = [5, 6, 4]"),m,_,s("：[7, 0, 8]"),f,v,s("：342 + 465 = 807"),g,b,s("："),n("a",x,[s("2.两数相加"),t(a)])])]),j,n("div",L,[N,n("p",null,[O,s("：给你一个链表，删除链表的倒数第n个结点，并且返回链表的头结点。"),P,R,s("：head = [1, 2, 3, 4, 5], n = 2"),I,T,s("：[1, 2, 3, 5]"),U,C,s("："),n("a",E,[s("19.删除链表的倒数第N个结点"),t(a)])])]),H,n("div",S,[V,n("p",null,[B,s("：给你一个链表，两两交换其中相邻的节点，并返回交换后链表的头节点。你必须在不修改节点内部的值的情况下完成本题。"),F,K,s("：head = [1, 2, 3, 4]"),M,z,s("：[2, 1, 4, 3]"),A,q,s("："),n("a",D,[s("24.两两交互链表中的节点"),t(a)])])]),G,n("div",J,[Q,n("p",null,[W,s("：给你一个长度为n的链表，每个节点包含一个额外增加的随机指针random，该指针可以指向链表中的任何节点或空节点，请构造这个链表的深拷贝。"),X,Y,s("：head = [[7, null], [13, 0], [11, 4], [10, 2], [1, 0]]"),Z,$,s("：[[7, null], [13, 0], [11, 4], [10, 2], [1, 0]]"),nn,sn,s("："),n("a",an,[s("138.随机链表的复制"),t(a)])])]),tn,n("div",pn,[on,n("p",null,[en,s("：给你一个长度为n的链表，每个节点包含一个额外增加的随机指针random，该指针可以指向链表中的任何节点或空节点，请构造这个链表的深拷贝。"),cn,ln,s("：head = [[7, null], [13, 0], [11, 4], [10, 2], [1, 0]]"),un,kn,s("：[[7, null], [13, 0], [11, 4], [10, 2], [1, 0]]"),rn,dn,s("："),n("a",hn,[s("142.环形链表Ⅱ"),t(a)])])]),yn,n("div",wn,[mn,n("p",null,[_n,s("：实现一个满足LRU缓存约束的数据结构。"),fn,vn,s("："),n("a",gn,[s("LRU解释"),t(a)]),bn,xn,s("："),n("a",jn,[s("146.LRU缓存"),t(a)])])]),Ln])}const In=o(u,[["render",Nn],["__file","index.html.vue"]]);export{In as default};
