import{_ as e,r as c,o as l,c as u,a,b as o,e as p,d as t}from"./app-d99c486e.js";const k={};function r(i,n){const s=c("leetcode-link");return l(),u("div",null,[n[0]||(n[0]=a("h1",{id:"中等",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#中等","aria-hidden":"true"},"#"),o(" 中等")],-1)),n[1]||(n[1]=a("h2",{id:"_33-搜索旋转排序数组",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#_33-搜索旋转排序数组","aria-hidden":"true"},"#"),o(" 33.搜索旋转排序数组")],-1)),p(s,{title:"33.搜索旋转排序数组",link:"https://leetcode.cn/problems/search-in-rotated-sorted-array"}),n[2]||(n[2]=t(`<p>方法一：分别找行和列</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// m为二维矩阵的行数、n为二维矩阵的列数</span>
