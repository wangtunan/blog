import{_ as e,r as c,o as l,c as k,a as t,b as o,e as a,d as p}from"./app-d99c486e.js";const u={};function r(i,n){const s=c("leetcode-link");return l(),k("div",null,[n[0]||(n[0]=t("h1",{id:"简单",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#简单","aria-hidden":"true"},"#"),o(" 简单")],-1)),n[1]||(n[1]=t("h2",{id:"_21-合并两个有序链表",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#_21-合并两个有序链表","aria-hidden":"true"},"#"),o(" 21.合并两个有序链表")],-1)),a(s,{title:"21.合并两个有序链表",link:"https://leetcode.cn/problems/merge-two-sorted-lists/"}),n[2]||(n[2]=p(`<p>方法一：递归</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// m和n分别为两个链表的长度</span>
