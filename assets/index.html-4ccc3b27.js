import{_ as e,r as c,o as u,c as l,a as t,b as o,e as a,d as p}from"./app-d99c486e.js";const k={};function r(i,n){const s=c("leetcode-link");return u(),l("div",null,[n[0]||(n[0]=t("h1",{id:"中等",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#中等","aria-hidden":"true"},"#"),o(" 中等")],-1)),n[1]||(n[1]=t("h2",{id:"_98-验证二叉搜索树",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#_98-验证二叉搜索树","aria-hidden":"true"},"#"),o(" 98.验证二叉搜索树")],-1)),a(s,{title:"98.验证二叉搜索树",link:"https://leetcode.cn/problems/validate-binary-search-tree"}),n[2]||(n[2]=p(`<p>方法一：递归</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// n为二叉树的节点数量</span>
