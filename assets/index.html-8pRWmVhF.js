import{_ as o,r as e,o as c,c as l,a as n,b as s,e as t,d as p}from"./app-iICYEmPT.js";const u={},k=n("h1",{id:"中等",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#中等","aria-hidden":"true"},"#"),s(" 中等")],-1),r=n("h2",{id:"_2-两数相加",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_2-两数相加","aria-hidden":"true"},"#"),s(" 2.两数相加")],-1),i={class:"custom-container tip"},d=n("p",{class:"custom-container-title"},"TIP",-1),h=n("strong",null,"要求",-1),y=n("br",null,null,-1),w=n("strong",null,"输入",-1),m=n("br",null,null,-1),_=n("strong",null,"输出",-1),f=n("br",null,null,-1),g=n("strong",null,"解释",-1),v=n("br",null,null,-1),x=n("strong",null,"原题链接",-1),b={href:"https://leetcode.cn/problems/add-two-numbers/",target:"_blank",rel:"noopener noreferrer"},j=p(`<div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// m为l1链表的长度，n为l2链表的长度</span>
