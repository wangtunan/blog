import{_ as o,r as e,o as c,c as l,e as a,a as n,b as t,d as p}from"./app-304441cd.js";const u={},k=n("h1",{id:"困难",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#困难","aria-hidden":"true"},"#"),t(" 困难")],-1),r=n("h2",{id:"_23-合并k个升序链表",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_23-合并k个升序链表","aria-hidden":"true"},"#"),t(" 23.合并K个升序链表")],-1),i=p(`<p>基础：合并两个有序链表。</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">var</span> <span class="token function-variable function">mergeTwoLists</span> <span class="token operator">=</span> <span class="token keyword">function</span><span class="token punctuation">(</span><span class="token parameter">list1<span class="token punctuation">,</span> list2</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
